...
export type RouteTypesById<TRouter extends RegisteredRouter, TId extends RouteIds<TRouter['routeTree']>> = RouteById<TRouter['routeTree'], TId>['types'];
export declare function getRouteApi<TRouter extends RegisteredRouter, TId extends RouteIds<TRouter['routeTree']>>(id: TId): RouteApi<TRouter, TId>;
export declare class RouteApi<TRouter extends RegisteredRouter, TId extends RouteIds<TRouter['routeTree']>> {
    id: TId;
    /**
